            ...
            <>
              {popUpInfo.Transaction_type === "deposit" ? (
                <div>
                  ...
                  <hr />
                  <p>For inquiries and concerns, click this link</p>
                </div>
              ) : (
                <div>
                  <img src={userprofile} className="user-profile" />
              ...
              {popUpInfo.Destination_username !== username ? (
                <div>
                  ...
                  <h3 className="user-fullname">
                    {popUpInfo.Destination_fname} {popUpInfo.Destination_lname}
                  </h3>
                  <small className="user-name">
                    {popUpInfo.Destination_username}
                  </small>
                  <h3 className="amount">₱ {popUpInfo.Amount}</h3>
                  <p>
                ...
                <div>
                  <img src={userprofile} className="user-profile" />
                  <h3 className="user-fullname">
                    {popUpInfo.Source_fname} {popUpInfo.Source_lname}
                  </h3>
                  <small className="user-name">
                    {popUpInfo.Source_username}
                  </small>
                  <h3 className="amount">₱ {popUpInfo.Amount}</h3>
                  <p>
                    You successfully received ₱ {popUpInfo.Amount} from{" "}
                    {popUpInfo.Source_fname} {popUpInfo.Source_lname} on{" "}
